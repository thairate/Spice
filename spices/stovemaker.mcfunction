schedule function spices:spices/stovemaker 20t

execute as @e[type=item,nbt={Item:{id:"minecraft:crafting_table",Count:1b}}] at @s if block ~ ~-0.2 ~ furnace align xz run function spices:spices/smaker
