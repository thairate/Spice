...
summon minecraft:area_effect_cloud ~ ~-0.7 ~ {Age:-2147483648,Duration:-1,WaitTime:-2147483648,Radius:0,Tags:["spice_craft","s_block"]}

setblock ~ ~-1 ~ dropper[facing=up]{CustomName:'{"text":"Stove Top","color":"dark_red","italic":false}'} replace
